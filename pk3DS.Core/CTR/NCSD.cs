...
public class NCSD
{
    ...
    {
        return Card2
            ? Align(((ulong)Header.OffsetSizeTable[NCCH_Array.Count - 1].Offset * NCCH.MEDIA_UNIT_SIZE)
                    + ((ulong)Header.OffsetSizeTable[NCCH_Array.Count - 1].Size * NCCH.MEDIA_UNIT_SIZE) + 0x1000, 0x10000) / MEDIA_UNIT_SIZE
            : 0x00000000FFFFFFFF;
    }
