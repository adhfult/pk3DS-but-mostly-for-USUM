...
partial class EvolutionEditor7
{
    ...
    private void InitializeComponent()
    {
        ...
        this.B_GenerateChangelog = new System.Windows.Forms.Button();
        ...
        this.GB_Randomizer.Location = new System.Drawing.Point(6, 290);
        ...
        // TC_Editor
        // 
        this.TC_Editor.Controls.Add(this.TP_General);
        this.TC_Editor.Controls.Add(this.TP_Changelog);
        this.TC_Editor.Location = new System.Drawing.Point(12, 40);
        this.TC_Editor.Name = "TC_Editor";
        this.TC_Editor.SelectedIndex = 0;
        this.TC_Editor.Size = new System.Drawing.Size(630, 480);
        this.TC_Editor.TabIndex = 119;
        // 
        // TP_General
        // 
        this.TP_General.Controls.Add(this.GB_Randomizer);
        ...
        this.TP_General.Controls.Add(this.CB_P8);
        this.TP_General.Controls.Add(this.CB_I8);
        this.TP_General.Controls.Add(this.label7);
        this.TP_General.Controls.Add(this.CB_M8);
        this.TP_General.Controls.Add(this.NUD_L7);
        this.TP_General.Controls.Add(this.NUD_F7);
        this.TP_General.Controls.Add(this.PB_7);
        this.TP_General.Controls.Add(this.CB_P7);
        this.TP_General.Controls.Add(this.CB_I7);
        this.TP_General.Controls.Add(this.label6);
        this.TP_General.Controls.Add(this.CB_M7);
        this.TP_General.Controls.Add(this.NUD_L6);
        this.TP_General.Controls.Add(this.NUD_F6);
        this.TP_General.Controls.Add(this.PB_6);
        this.TP_General.Controls.Add(this.CB_P6);
        this.TP_General.Controls.Add(this.CB_I6);
        this.TP_General.Controls.Add(this.label5);
        this.TP_General.Controls.Add(this.CB_M6);
        this.TP_General.Controls.Add(this.NUD_L5);
        this.TP_General.Controls.Add(this.NUD_F5);
        this.TP_General.Controls.Add(this.PB_5);
        this.TP_General.Controls.Add(this.CB_P5);
        this.TP_General.Controls.Add(this.CB_I5);
        this.TP_General.Controls.Add(this.label4);
        this.TP_General.Controls.Add(this.CB_M5);
        this.TP_General.Controls.Add(this.NUD_L4);
        this.TP_General.Controls.Add(this.NUD_F4);
        this.TP_General.Controls.Add(this.PB_4);
        this.TP_General.Controls.Add(this.CB_P4);
        this.TP_General.Controls.Add(this.CB_I4);
        this.TP_General.Controls.Add(this.label3);
        this.TP_General.Controls.Add(this.CB_M4);
        this.TP_General.Controls.Add(this.NUD_L3);
        this.TP_General.Controls.Add(this.NUD_F3);
        this.TP_General.Controls.Add(this.PB_3);
        this.TP_General.Controls.Add(this.CB_P3);
        this.TP_General.Controls.Add(this.CB_I3);
        this.TP_General.Controls.Add(this.label2);
        this.TP_General.Controls.Add(this.CB_M3);
        this.TP_General.Controls.Add(this.NUD_L2);
        this.TP_General.Controls.Add(this.NUD_F2);
        this.TP_General.Controls.Add(this.PB_2);
        this.TP_General.Controls.Add(this.CB_P2);
        this.TP_General.Controls.Add(this.CB_I2);
        this.TP_General.Controls.Add(this.label1);
        this.TP_General.Controls.Add(this.CB_M2);
        this.TP_General.Controls.Add(this.NUD_L1);
        this.TP_General.Controls.Add(this.NUD_F1);
        this.TP_General.Controls.Add(this.PB_1);
        this.TP_General.Controls.Add(this.CB_P1);
        this.TP_General.Controls.Add(this.CB_I1);
        this.TP_General.Controls.Add(this.L_M1);
        this.TP_General.Controls.Add(this.CB_M1);
        this.TP_General.Location = new System.Drawing.Point(4, 22);
        this.TP_General.Name = "TP_General";
        this.TP_General.Padding = new System.Windows.Forms.Padding(3);
        this.TP_General.Size = new System.Drawing.Size(622, 434);
        ...
        this.TP_Changelog.Size = new System.Drawing.Size(622, 434);
        ...
        this.B_GenerateChangelog.Text = "Generate Changelog";
        this.B_GenerateChangelog.UseVisualStyleBackColor = true;
        this.B_GenerateChangelog.Click += new System.EventHandler(this.B_GenerateChangelog_Click);
        // 
        // RTB_Changelog
        // 
        ...
        this.RTB_Changelog.Size = new System.Drawing.Size(616, 428);
    ...
    private System.Windows.Forms.Button B_GenerateChangelog;
